...
const Description1 = '<p>This project is a two page responsive website I built for a technology conference.</p> ';
...
const Description3 = '<p>A Web application based on an external API. The application has 2 user interfaces: homepage where you can you can like your favorite meals and comments interface where you can add comments;</p> ';
